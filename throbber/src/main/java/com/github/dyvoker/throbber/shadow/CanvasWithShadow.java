...
public class CanvasWithShadow {
	 ...
	 */
	public CanvasWithShadow(
		@NonNull Canvas canvas,
		@NonNull DensityConverter densityConverter
	) {
		this(canvas.getWidth(), canvas.getHeight(), Bitmap.Config.ARGB_8888, densityConverter);
	}
	...
	public CanvasWithShadow(
		...
		this(canvas.getWidth(), canvas.getHeight(), config, densityConverter);
	}
